...
namespace ClinicaSistema.Controllers
{
    public class EspecialidadesController : Controller
    {
        ...
        public EspecialidadesController(dbclinicaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Especialidades != null ? 
                          ...
                          Problem("Entity set 'dbclinicaContext.Especialidades'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'dbclinicaContext.Especialidades'  is null.");
            }
            var especialidade = await _context.Especialidades.FindAsync(id);
            if (especialidade != null)
            {
        ...
        {
          return (_context.Especialidades?.Any(e => e.EspecialidadeId == id)).GetValueOrDefault();
        }
    }
}
