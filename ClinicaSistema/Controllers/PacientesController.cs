...
namespace ClinicaSistema.Controllers
{
    public class PacientesController : Controller
    {
        ...
        public PacientesController(dbclinicaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Pacientes != null ? 
                          ...
                          Problem("Entity set 'dbclinicaContext.Pacientes'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("PacienteId,Nome")] Paciente paciente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PacienteId,Nome")] Paciente paciente)
        {
